<script src="../../node_modules/gcode-preview/dist/gcode-preview.js"></script>
<template>
  <div>
...
export default {
  ...
  mounted() {
    this.preview = new GCodePreview.init({
      ...
      renderTravel:this.renderTravel,
      travelColor:this.travelColor,
      renderTubes: this.renderTubes
    });
